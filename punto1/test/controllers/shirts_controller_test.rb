...
class ShirtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post shirts_url, params: { shirt: { material: @shirt.material, price: @shirt.price, size: @shirt.size } }
    end
  ...
  test "should update shirt" do
    patch shirt_url(@shirt), params: { shirt: { material: @shirt.material, price: @shirt.price, size: @shirt.size } }
