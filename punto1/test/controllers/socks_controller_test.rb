...
class SocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sock" do
    assert_difference('Sock.count') do
      post socks_url, params: { sock: { color: @sock.color, material: @sock.material, price: @sock.price } }
    end
  ...
  test "should update sock" do
    patch sock_url(@sock), params: { sock: { color: @sock.color, material: @sock.material, price: @sock.price } }
